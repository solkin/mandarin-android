...
import com.tomclaw.mandarin.main.icq.IcqAccountAddActivity;
...
public class MainActivity extends ChiefActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (PreferenceHelper.isShowStartHelper(this)) {
            // This will start
            Intent accountAddIntent = new Intent(this, IcqAccountAddActivity.class);
            accountAddIntent.putExtra(IcqAccountAddActivity.EXTRA_START_HELPER, true);
