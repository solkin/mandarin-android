...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultBackgroundColor = res.getColor(R.color.default_background_color);
        ...
        final int backgroundColor = a.getColor(R.styleable.TitlePageIndicator_android_background, defaultBackgroundColor);
